...
golem::fill_desc(
  pkg_name = "shiymatrix", # The Name of the package containing the App 
  pkg_title = "Matrix", # The Title of the package containing the App 
  pkg_description = "Choose your pill.", # The Description of the package containing the App 
...
usethis::use_mit_license( name = "Girard Cervan" )  # You can set another licence here
